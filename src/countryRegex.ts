...
export const countryRegexMap: Map<Country, string> = new Map([
  ...
  [Country.Chile, String.raw``],
  [Country.China, String.raw`^[a-zA-Z0-9]{18}$`],
  [Country.Colombia, String.raw``],
  [Country.CostaRica, String.raw``],
  ...
  [Country.DominicanRepublic, String.raw``],
  [Country.Ecuador, String.raw``],
  [Country.ElSalvador, String.raw``],
  ...
  [Country.Guatemala, String.raw``],
  [Country.Honduras, String.raw``],
